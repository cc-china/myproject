...
public class ShortStandardGSYVideoPlayer extends GSYVideoPlayer {
    ...
    private boolean isClickAllHideView = false;//屏蔽显示页面布局点击
    /////////////////- 拓展直播隐藏布局-////////////////
    private RelativeLayout layout_hide_progress;
    ...
    public ShortStandardGSYVideoPlayer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void init(Context context) {
        ...
        layout_hide_progress = (RelativeLayout) findViewById(R.id.layout_hide_progress);
        ...
        if (isClickAllHideView) {
            layout_hide_progress.setVisibility(GONE);
        }
    }
...
//        mBottomContainer.setVisibility(View.INVISIBLE);
    ...
    public GSYBaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        ...
        if (gsyBaseVideoPlayer != null) {
            ShortStandardGSYVideoPlayer gsyVideoPlayer = (ShortStandardGSYVideoPlayer) gsyBaseVideoPlayer;
...
//        mBottomContainer.setVisibility(View.INVISIBLE);
     ...
     * isClickAllHideView
     * */
    public void setClickAllHideView(boolean isClickAllHideView) {
        this.isClickAllHideView = isClickAllHideView;
    }
}
