        ...
        if (handler == null) {
            handler = new Handler(new Handler.Callback() {
                ...
                public boolean handleMessage(Message msg) {
                    switch (msg.what){
                        case 1:
                            Toast.makeText(Snackbar.this,(String)msg.obj,0).show();
                            break;
                    }
                    return false;
                }
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                handler.post(new Runnable() {
                    @Override
                    public void run() {
                        final android.support.design.widget.Snackbar make = android.support.design.widget.Snackbar.make(btn, "design 测试", android.support.design.widget.Snackbar.LENGTH_INDEFINITE);
